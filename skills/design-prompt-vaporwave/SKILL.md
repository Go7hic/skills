---
name: design-prompt-vaporwave
description: Use when the user wants a landing page, interface, or visual system in the Vaporwave style from Design Prompts, or explicitly asks for vaporwave
---

# Design Prompt Vaporwave

## Overview

Use this skill when the user wants the Vaporwave aesthetic. Keep the target product's content and requirements intact, then translate this style into the requested stack or artifact.
...
- Requests for the Vaporwave style or close synonyms tied to this aesthetic
...
- Design a [surface] for [brand or product] in the "Vaporwave" style.
- Keep the visual system dark-first with #FF00FF as the anchor accent.
