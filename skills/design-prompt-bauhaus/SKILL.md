---
name: design-prompt-bauhaus
description: Use when the user wants a landing page, interface, or visual system in the Bauhaus style from Design Prompts, or explicitly asks for bauhaus
---

# Design Prompt Bauhaus

## Overview

Use this skill when the user wants the Bauhaus aesthetic. Keep the target product's content and requirements intact, then translate this style into the requested stack or artifact.
...
- Requests for the Bauhaus style or close synonyms tied to this aesthetic
...
- Design a [surface] for [brand or product] in the "Bauhaus" style.
- Keep the visual system light-first with #D02020 as the anchor accent.
- Use a clean sans-led hierarchy with confident sizing.
- Start from these section archetypes when relevant: hero, stats, features, how-it-works, benefits, pricing, testimonials, faq, blog, footer.
